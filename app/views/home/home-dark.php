        ...
        <header id="header" class="header">
            <div class="header__container d-flex justify-content-between align-items-center">
                ...
                <div class="header__logo">
                    <!-- Your Logo Here -->
                    <img src="img/logo-light.svg" alt="Finley Template Logo">
                </div>
                <!-- Template Logo End -->
            ...
            <div class="container-fluid p-0 fullheight">
                <div class="row g-0 fullheight">
                    ...
                    <div class="col-12 col-xl-6 main__media">
                        ...
                        <!-- Media Footer Start -->
                        <div class="media__footer d-flex justify-content-center justify-content-xl-end align-items-center">
                            <div class="footer__halfline halfline-2 two-sides-topline"></div>
                            <p class="copyright">
                                Made with 
                                <i class="fa-solid fa-heart"></i> 
                                <a href="https://1.envato.market/EKA9WD" target="_blank" class="link-s"> by Mix_Design</a>, 2024
                ...
                <div class="inner__content">
                    ...
                    <div class="content-wrapper">
                        <div class="container-fluid px-0">
                            ...
                            <div class="row gx-0">
                                <div class="col-12 col-xl-6">
                                    <div class="content-block">
                                        <div class="text-content-block">
                                            ...
                                            <h2 class="block__title">Just <span class="italic">awesome</span> template to kick-start your new <span class="bold">project</span></h2>
                                ...
                                <div class="col-12 col-xl-6">
                                    <!-- image block -->
                                    <div class="image-block inner-image-block-1"></div>
                                </div>
                            </div>
                            <!-- About Us Description & Image #1 End -->

                            <!-- About Us Description & Image #2 Start -->
                            <div class="row gx-0 flex-xl-row-reverse">
                                ...
                                <div class="col-12 col-xl-6">
                                    <!-- image block -->
                                    <div class="image-block inner-image-block-2"></div>
                                </div>
                            </div>
                            <!-- About Us Description & Image #2 End -->

                        </div>
                    </div>
                    <!-- Inner Content Part End -->

                    <!-- Inner Media Part Start -->
                    <div class="media-wrapper">
                        ...
                        <div class="inner-video">
                            ...
                            <!-- video trigger -->
                            <a data-text="Play" href="https://vimeo.com/65036292" id="inner-video-trigger" class="inner-video-trigger link-xl">Play</a>
                            </div>
                        </div>
                        <!-- Video Popup Trigger Block End -->
                    </div>
                    <!-- Inner Media Part End -->
                                    ...
                                    <div class="content-block">
                                        <div class="text-content-block">
                                            ...
                                            <div class="container-fluid px-0">
                                                <div class="row gx-5">
                                                    <div class="col-12 col-xl-6">
                                                        <h2 class="block__title">Meet the <span class="italic">team</span></h2>
                                                        <p class="block__text">I wonder if I've been changed in the night?
                                                            Let me think. Was I the same when I got up this morning?
                                                            I almost think I can remember feeling a little different.
                                                            But if I'm not the same, the next question is 'Who in the world am I?' Ah, that's the great puzzle!
                                        ...
                                        <div class="text-content-block">
                                            ...
                                            <div class="container-fluid px-0">
                                                <div class="row gx-5">
                                                    <div class="col-12 col-xl-6">
                                                        ...
                                                        <h2 class="block__title">Meet our featured <span class="italic">projects</span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="container-fluid px-0">
                                                <div class="row gx-5 my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                                                    <!-- gallery single item -->
                                                    <figure class="col-12 col-md-6 col-xl-4 my-gallery__item link-xl"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                                        <a href="https://dummyimage.com/1200x1200/4d4d4d/636363" data-image="https://dummyimage.com/1200x1200/4d4d4d/636363" class="works-link" itemprop="contentUrl" data-size="1200x1200">
                                                            <img src="https://dummyimage.com/1200x1200/4d4d4d/636363" class="works-image" itemprop="thumbnail" alt="Project Example">
                                                        </a>
                                                    ...
                                                    <figure class="col-12 col-md-6 col-xl-4 my-gallery__item link-xl"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                                        ...
                                                        <h3>
                                                            Laconic case
                                                            <small>Consept / Product design</small>
                                                        </h3>
                                                        <p class="light">Why, sometimes Im afraid so, but let me tell you something, the best people usualy are.</p>
                                                        </figcaption>
                                                    </figure>
